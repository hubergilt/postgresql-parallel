...
-- Procedure 1: Compute sum of first 10000 prime numbers
...
BEGIN
    ...
    RAISE NOTICE 'Computing sum of first 100000 prime numbers...';
    
    -- Find first 100000 prime numbers and sum them
